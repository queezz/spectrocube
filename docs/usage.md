...
Loads a file and prints a compact human-readable summary including instrument
metadata, wavelength range, intensity dimensions, and a one-line validation result.
